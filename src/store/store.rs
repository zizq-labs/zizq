...
use super::options::{
    CronEntryOptions, ListErrorsOptions, ListJobsOptions, ReplaceCronGroupOptions,
};
...
mod tests {
    ...
    use crate::store::options::{BulkDeleteOptions, CronEntryOptions, EnqueueOptions};
    use crate::store::test_support::{enqueue_and_take, test_failure_opts, test_store};
