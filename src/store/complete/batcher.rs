...
fn process_batch(
    ...
    for p in &prepared {
        ...
        // Two separate things, and a completing job needs both: the
        // slot it occupied while running goes back, and it stops being
        // counted as outstanding work at all.
        dispatch.release_concurrency(&p.budgets);
